...
export default function TaskCard({ task, onEdit, onDelete, onStatusChange }: TaskCardProps) {
  ...
  return (
    <div className={`glass rounded-2xl p-5 border-l-4 ${pConfig.border} animate-fade-in-up ${isOverdue ? "ring-1 ring-red-300 dark:ring-red-800" : ""}`}>
      ...
      <div className="flex flex-wrap gap-2 mb-3">
        ...
        <select
          ...
          className={`text-xs font-medium px-2 py-1 rounded-full border-0 cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary/50 ${
      ...
      <div className={`flex items-center gap-1.5 text-xs ${dueDateStyle}`}>
        <Calendar size={13} />
